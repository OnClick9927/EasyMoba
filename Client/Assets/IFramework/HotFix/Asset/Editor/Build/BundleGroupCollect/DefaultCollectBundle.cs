        ...
        public class DefaultCollectBundle : ICollectBundle
        {
            ...
            public static void OneFileBundle_ALL(List<AssetInfo> assets, List<BundleGroup> result)
            {
                foreach (var atlas in assets)
                {
                    ...
                    BundleGroup atlasBundle = new BundleGroup(atlas.parentPath.CombinePath(file_name).ToAssetsPath());
            ...
            public static void SizeBundle_ALL(string baseName, List<AssetInfo> assets, Dictionary<AssetInfo, List<AssetInfo>> dpdic, List<BundleGroup> result)
            {
                ...
                {
                    BundleGroup lastBundle = new BundleGroup(baseName.Append($"_{_index.Key}"));
