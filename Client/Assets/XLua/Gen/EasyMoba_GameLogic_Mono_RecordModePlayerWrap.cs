...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicMonoRecordModePlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.Mono.RecordModePlayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.GameLogic.Mono.RecordModePlayer constructor!");
        ...
        static int _m_CallServerReady(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.Mono.RecordModePlayer gen_to_be_invoked = (EasyMoba.GameLogic.Mono.RecordModePlayer)translator.FastGetCSObj(L, 1);
