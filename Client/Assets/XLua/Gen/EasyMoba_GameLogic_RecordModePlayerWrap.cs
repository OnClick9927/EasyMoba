...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicRecordModePlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.RecordModePlayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MatchRoomType>(L, 2) && translator.Assignable<System.Collections.Generic.List<long>>(L, 3))
				{
					...
					var gen_ret = new EasyMoba.GameLogic.RecordModePlayer(_type, _roles);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.GameLogic.RecordModePlayer constructor!");
        ...
        static int _m_CallServerReady(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.RecordModePlayer gen_to_be_invoked = (EasyMoba.GameLogic.RecordModePlayer)translator.FastGetCSObj(L, 1);
