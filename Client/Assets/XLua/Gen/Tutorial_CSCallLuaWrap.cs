...
namespace XLua.CSObjectWrap
{
    ...
    public class TutorialCSCallLuaWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Tutorial.CSCallLua);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Tutorial.CSCallLua gen_ret = new Tutorial.CSCallLua();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Tutorial.CSCallLua constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                Tutorial.CSCallLua gen_to_be_invoked = (Tutorial.CSCallLua)translator.FastGetCSObj(L, 1);
