...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAssetBundleRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.AssetBundleRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AssetBundleRequest gen_ret = new UnityEngine.AssetBundleRequest();
        ...
        static int _m_GetAwaiter(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AssetBundleRequest gen_to_be_invoked = (UnityEngine.AssetBundleRequest)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    
                        IFramework.IAwaiter<UnityEngine.AssetBundleRequest> gen_ret = gen_to_be_invoked.GetAwaiter(  );
        ...
        static int _g_get_allAssets(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AssetBundleRequest gen_to_be_invoked = (UnityEngine.AssetBundleRequest)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.allAssets);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
