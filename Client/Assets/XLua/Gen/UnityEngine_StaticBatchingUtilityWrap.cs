...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineStaticBatchingUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.StaticBatchingUtility);
        ...
        static int _m_Combine_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.GameObject _staticBatchRoot = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                    
                    UnityEngine.StaticBatchingUtility.Combine( _staticBatchRoot );
                ...
                {
                    UnityEngine.GameObject[] _gos = (UnityEngine.GameObject[])translator.GetObject(L, 1, typeof(UnityEngine.GameObject[]));
                    UnityEngine.GameObject _staticBatchRoot = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
                    
                    UnityEngine.StaticBatchingUtility.Combine( _gos, _staticBatchRoot );
