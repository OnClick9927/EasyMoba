...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.AudioRenderer);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "Render", _m_Render_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.AudioRenderer constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSampleCountForCaptureFrame_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Render_xlua_st_(RealStatePtr L)
        {
		    try {
