...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkNetHttpHttpPostWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Net.Http.HttpPost);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Net.Http.HttpPost constructor!");
        ...
        static int _m_GetDo(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Net.Http.HttpPost gen_to_be_invoked = (IFramework.Net.Http.HttpPost)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Response(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Net.Http.HttpPost.Response!");
