...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetWebRequestBundleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.WebRequestBundle);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.WebRequestBundle constructor!");
        ...
        static int _g_get_progress(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.WebRequestBundle gen_to_be_invoked = (IFramework.Hotfix.Asset.WebRequestBundle)translator.FastGetCSObj(L, 1);
