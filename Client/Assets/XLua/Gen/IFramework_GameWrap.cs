...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkGameWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "envType", _g_get_envType);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "envType", _s_set_envType);
        ...
        static int _g_get_envType(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Game gen_to_be_invoked = (IFramework.Game)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.envType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_envType(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Game gen_to_be_invoked = (IFramework.Game)translator.FastGetCSObj(L, 1);
                IFramework.EnvironmentType gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.envType = gen_value;
