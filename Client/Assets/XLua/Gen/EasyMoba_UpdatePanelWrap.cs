...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaUpdatePanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.UpdatePanel);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					EasyMoba.UpdatePanel gen_ret = new EasyMoba.UpdatePanel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.UpdatePanel constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.UpdatePanel gen_to_be_invoked = (EasyMoba.UpdatePanel)translator.FastGetCSObj(L, 1);
