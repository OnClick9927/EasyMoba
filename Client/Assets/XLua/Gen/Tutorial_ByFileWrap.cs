...
namespace XLua.CSObjectWrap
{
    ...
    public class TutorialByFileWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Tutorial.ByFile);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Tutorial.ByFile gen_ret = new Tutorial.ByFile();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Tutorial.ByFile constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                Tutorial.ByFile gen_to_be_invoked = (Tutorial.ByFile)translator.FastGetCSObj(L, 1);
