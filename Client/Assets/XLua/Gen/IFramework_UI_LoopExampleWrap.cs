...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUILoopExampleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.LoopExample);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "guide", _g_get_guide);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "rect", _s_set_rect);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "btns", _s_set_btns);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "guide", _s_set_guide);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.UI.LoopExample gen_ret = new IFramework.UI.LoopExample();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.LoopExample constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.LoopExample gen_to_be_invoked = (IFramework.UI.LoopExample)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_guide(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                IFramework.UI.LoopExample gen_to_be_invoked = (IFramework.UI.LoopExample)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.guide);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_rect(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.LoopExample gen_to_be_invoked = (IFramework.UI.LoopExample)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.rect = (IFramework.UI.LoopScrollRect)translator.GetObject(L, 2, typeof(IFramework.UI.LoopScrollRect));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_guide(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                IFramework.UI.LoopExample gen_to_be_invoked = (IFramework.UI.LoopExample)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.guide = (IFramework.UI.GuideMask)translator.GetObject(L, 2, typeof(IFramework.UI.GuideMask));
