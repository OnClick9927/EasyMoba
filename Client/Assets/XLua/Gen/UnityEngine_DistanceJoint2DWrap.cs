...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineDistanceJoint2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.DistanceJoint2D);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.DistanceJoint2D gen_ret = new UnityEngine.DistanceJoint2D();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.DistanceJoint2D gen_to_be_invoked = (UnityEngine.DistanceJoint2D)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_maxDistanceOnly(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.DistanceJoint2D gen_to_be_invoked = (UnityEngine.DistanceJoint2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.maxDistanceOnly);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_maxDistanceOnly(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.DistanceJoint2D gen_to_be_invoked = (UnityEngine.DistanceJoint2D)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.maxDistanceOnly = LuaAPI.lua_toboolean(L, 2);
