...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIMVCMvcGroupsWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) >= 1 && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 2) || translator.Assignable<System.Collections.Generic.Dictionary<string, System.Type>>(L, 2)))
				{
					System.Collections.Generic.Dictionary<string, System.Type>[] _maps = translator.GetParams<System.Collections.Generic.Dictionary<string, System.Type>>(L, 2);
        ...
        static int _m_Subscribe(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.UI.UIPanel _panel = (IFramework.UI.UIPanel)translator.GetObject(L, 3, typeof(IFramework.UI.UIPanel));
                    
                        var gen_ret = gen_to_be_invoked.Subscribe( _path, _panel );
