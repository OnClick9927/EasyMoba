...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaMapInitDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.MapInitData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.MapInitData constructor!");
        ...
        static int _g_get_ps(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.MapInitData gen_to_be_invoked = (EasyMoba.MapInitData)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_ps(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.MapInitData gen_to_be_invoked = (EasyMoba.MapInitData)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.ps = (EasyMoba.MapInitData.PolygonData[])translator.GetObject(L, 2, typeof(EasyMoba.MapInitData.PolygonData[]));
        ...
        static int _s_set_cs(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.MapInitData gen_to_be_invoked = (EasyMoba.MapInitData)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.cs = (EasyMoba.MapInitData.CircleData[])translator.GetObject(L, 2, typeof(EasyMoba.MapInitData.CircleData[]));
