...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicSkillEffectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.SkillEffect);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new EasyMoba.GameLogic.SkillEffect();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.GameLogic.SkillEffect constructor!");
        ...
        static int _g_get_effectID(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.SkillEffect gen_to_be_invoked = (EasyMoba.GameLogic.SkillEffect)translator.FastGetCSObj(L, 1);
