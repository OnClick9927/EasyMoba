...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetsWrap 
    {
        ...
        static int _m_CopyDLCFromSteam_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.Hotfix.Asset.Assets.CopyDLCFromSteam(  );
        ...
        static int _m_InitAsync_xlua_st_(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.Assets.InitAsync!");
        ...
        static int _m_UnloadBundles_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.Hotfix.Asset.Assets.UnloadBundles(  );
        ...
        static int _m_Destroy_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.Hotfix.Asset.Assets.Destroy( _gameObject );
