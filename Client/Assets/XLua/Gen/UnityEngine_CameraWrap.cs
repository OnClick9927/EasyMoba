...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 46, 57, 44);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Screenshot", _m_Screenshot);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Screenshot(RealStatePtr L)
        {
		    try {
