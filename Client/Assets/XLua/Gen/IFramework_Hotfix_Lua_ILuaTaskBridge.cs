...
{
    public class IFrameworkHotfixLuaILuaTaskBridge : LuaBase, IFramework.Hotfix.Lua.ILuaTask
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new IFrameworkHotfixLuaILuaTaskBridge(reference, luaenv);
		}
		
		public IFrameworkHotfixLuaILuaTaskBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		object IFramework.Hotfix.Lua.ILuaTask.GetResult()
		{
		...
		string IFramework.Hotfix.Lua.ILuaTask.GetException()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void IFramework.Hotfix.Lua.ILuaTask.OnCompleted(System.Action continuation)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
        ...
        bool IFramework.Hotfix.Lua.ILuaTask.IsCompleted 
        {
