...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicMonoLocalModePlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.Mono.LocalModePlayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MatchRoomType>(L, 2) && translator.Assignable<System.Collections.Generic.List<BattlePlayer>>(L, 3))
				{
					...
					var gen_ret = new EasyMoba.GameLogic.Mono.LocalModePlayer(_type, _roles);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.GameLogic.Mono.LocalModePlayer constructor!");
        ...
        static int _m_CallServerReady(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.Mono.LocalModePlayer gen_to_be_invoked = (EasyMoba.GameLogic.Mono.LocalModePlayer)translator.FastGetCSObj(L, 1);
