...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaPolygonShapeComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.PolygonShapeComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					EasyMoba.PolygonShapeComponent gen_ret = new EasyMoba.PolygonShapeComponent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.PolygonShapeComponent constructor!");
        ...
        static int _m_Build(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.PolygonShapeComponent gen_to_be_invoked = (EasyMoba.PolygonShapeComponent)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    
                        LockStep.LCollision2D.PolygonShape gen_ret = gen_to_be_invoked.Build(  );
                        translator.Push(L, gen_ret);
