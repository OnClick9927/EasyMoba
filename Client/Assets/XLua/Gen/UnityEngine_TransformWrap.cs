...
using IFramework;using IFramework.Hotfix.Lua;
...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 27, 19, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetLuaBehaviour", _m_GetLuaBehaviour);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetLuaBehaviourSelf", _m_GetLuaBehaviourSelf);
        ...
        static int _m_GetPath(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string gen_ret = gen_to_be_invoked.GetPath(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetLuaBehaviour(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        IFramework.Hotfix.Lua.LuaBehaviour gen_ret = gen_to_be_invoked.GetLuaBehaviour(  );
                        translator.Push(L, gen_ret);
                ...
                {
                    string _requireParam = LuaAPI.lua_tostring(L, 2);
                    
                        IFramework.Hotfix.Lua.LuaBehaviour gen_ret = gen_to_be_invoked.GetLuaBehaviour( _requireParam );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetLuaBehaviour!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetLuaBehaviourSelf(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        object gen_ret = gen_to_be_invoked.GetLuaBehaviourSelf(  );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _requireParam = LuaAPI.lua_tostring(L, 2);
                        ...
                        object gen_ret = gen_to_be_invoked.GetLuaBehaviourSelf( _requireParam );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetLuaBehaviourSelf!");
