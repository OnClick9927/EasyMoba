...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetExampleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.AssetExample);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.Hotfix.Asset.AssetExample gen_ret = new IFramework.Hotfix.Asset.AssetExample();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.AssetExample constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.AssetExample gen_to_be_invoked = (IFramework.Hotfix.Asset.AssetExample)translator.FastGetCSObj(L, 1);
