...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetsInternalDownloaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.AssetsInternal.Downloader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.AssetsInternal.Downloader constructor!");
        ...
        static int _m_Start(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.AssetsInternal.Downloader gen_to_be_invoked = (IFramework.Hotfix.Asset.AssetsInternal.Downloader)translator.FastGetCSObj(L, 1);
