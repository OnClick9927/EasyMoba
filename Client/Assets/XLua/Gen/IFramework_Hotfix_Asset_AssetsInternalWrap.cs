    ...
    public class IFrameworkHotfixAssetAssetsInternalWrap 
    {
        ...
        static int _g_get_downloadDirectory(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushstring(L, IFramework.Hotfix.Asset.AssetsInternal.downloadDirectory);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_downloadDirectory(RealStatePtr L)
        {
		    try {
			    ...
			    IFramework.Hotfix.Asset.AssetsInternal.downloadDirectory = LuaAPI.lua_tostring(L, 1);
