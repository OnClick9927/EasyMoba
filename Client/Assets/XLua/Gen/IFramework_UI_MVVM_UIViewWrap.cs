...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIMVVMUIViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.MVVM.UIView);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.UI.MVVM.UIView does not have a constructor!");
        }
        ...
        static int _g_get_lastState(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.MVVM.UIView gen_to_be_invoked = (IFramework.UI.MVVM.UIView)translator.FastGetCSObj(L, 1);
