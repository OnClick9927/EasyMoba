...
namespace XLua.CSObjectWrap
{
    ...
    public class WooAssetAssetsSettingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WooAsset.AssetsSetting);
        ...
        {
            return LuaAPI.luaL_error(L, "WooAsset.AssetsSetting does not have a constructor!");
        }
        ...
        static int _m_GetUrlByBundleName(RealStatePtr L)
        {
		    try {
                ...
                WooAsset.AssetsSetting gen_to_be_invoked = (WooAsset.AssetsSetting)translator.FastGetCSObj(L, 1);
