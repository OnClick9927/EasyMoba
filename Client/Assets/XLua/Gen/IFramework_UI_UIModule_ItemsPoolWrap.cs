...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIUIModuleItemsPoolWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.UIModule.ItemsPool);
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 0, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get", _m_Get);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set", _m_Set);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Clear", _m_Clear);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ClearUseless", _m_ClearUseless);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.UIModule.ItemsPool constructor!");
        ...
        static int _m_Get(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.UIModule.ItemsPool gen_to_be_invoked = (IFramework.UI.UIModule.ItemsPool)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Set(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                    IFramework.UI.UIItem _item = (IFramework.UI.UIItem)translator.GetObject(L, 3, typeof(IFramework.UI.UIItem));
                    
                    gen_to_be_invoked.Set( _path, _item );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.GameObject>(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.Set( _path, _go );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.UIModule.ItemsPool.Set!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ClearUseless(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ClearUseless(  );
