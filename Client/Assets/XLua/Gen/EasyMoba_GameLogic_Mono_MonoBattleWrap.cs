...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicMonoMonoBattleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "OnUnitCreate", _m_OnUnitCreate);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_OnUnitCreate(RealStatePtr L)
        {
		    try {
                ...
                {
                    EasyMoba.GameLogic.MobaUnit _unit = (EasyMoba.GameLogic.MobaUnit)translator.GetObject(L, 2, typeof(EasyMoba.GameLogic.MobaUnit));
                    
                    gen_to_be_invoked.OnUnitCreate( _unit );
