...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkSerializationDataTableDataExplainerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Serialization.DataTable.DataExplainer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Serialization.DataTable.DataExplainer constructor!");
