...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetOperationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.AssetOperation);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.Hotfix.Asset.AssetOperation does not have a constructor!");
        }
        ...
        static int _m_WaitForComplete(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.AssetOperation gen_to_be_invoked = (IFramework.Hotfix.Asset.AssetOperation)translator.FastGetCSObj(L, 1);
        ...
        static int _e_completed(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.AssetOperation.completed!");
            return 0;
        }
