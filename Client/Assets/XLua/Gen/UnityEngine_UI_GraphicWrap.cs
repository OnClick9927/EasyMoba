...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIGraphicWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 23, 11, 4);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "raycastPadding", _g_get_raycastPadding);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "raycastPadding", _s_set_raycastPadding);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Camera _eventCamera = (UnityEngine.Camera)translator.GetObject(L, 3, typeof(UnityEngine.Camera));
                        ...
                        var gen_ret = gen_to_be_invoked.Raycast( _sp, _eventCamera );
        ...
        static int _m_GetPixelAdjustedRect(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetPixelAdjustedRect(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_raycastPadding(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.UI.Graphic gen_to_be_invoked = (UnityEngine.UI.Graphic)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineVector4(L, gen_to_be_invoked.raycastPadding);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_raycastPadding(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				...
				gen_to_be_invoked.raycastPadding = gen_value;
