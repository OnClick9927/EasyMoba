...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineOcclusionPortalWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.OcclusionPortal);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.OcclusionPortal gen_ret = new UnityEngine.OcclusionPortal();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.OcclusionPortal gen_to_be_invoked = (UnityEngine.OcclusionPortal)translator.FastGetCSObj(L, 1);
