...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaPlayerBornPlaceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.PlayerBornPlace);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					EasyMoba.PlayerBornPlace gen_ret = new EasyMoba.PlayerBornPlace();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.PlayerBornPlace constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.PlayerBornPlace gen_to_be_invoked = (EasyMoba.PlayerBornPlace)translator.FastGetCSObj(L, 1);
