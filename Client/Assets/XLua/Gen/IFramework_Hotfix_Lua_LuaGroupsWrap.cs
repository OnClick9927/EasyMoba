...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixLuaLuaGroupsWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups constructor!");
        ...
        static int _e_onDispose(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups.onDispose!");
            return 0;
        }
        ...
        static int _e_onSubscribe(RealStatePtr L)
        {
		    try {
			    ...
			    int gen_param_count = LuaAPI.lua_gettop(L);
			IFramework.Hotfix.Lua.LuaGroups gen_to_be_invoked = (IFramework.Hotfix.Lua.LuaGroups)translator.FastGetCSObj(L, 1);
                System.Func<string, string, IFramework.UI.UIPanel, bool> gen_delegate = translator.GetDelegate<System.Func<string, string, IFramework.UI.UIPanel, bool>>(L, 3);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#3 need System.Func<string, string, IFramework.UI.UIPanel, bool>!");
                }
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups.onSubscribe!");
            return 0;
        }
        ...
        static int _e_onUnSubscribe(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups.onUnSubscribe!");
            return 0;
        }
        ...
        static int _e_onLoad(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups.onLoad!");
            return 0;
        }
        ...
        static int _e_onShow(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups.onShow!");
            return 0;
        }
        ...
        static int _e_onClose(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups.onClose!");
            return 0;
        }
