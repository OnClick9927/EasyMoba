...
namespace XLua.CSObjectWrap
{
    ...
    public class TutorialCustomLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Tutorial.CustomLoader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Tutorial.CustomLoader();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Tutorial.CustomLoader constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                Tutorial.CustomLoader gen_to_be_invoked = (Tutorial.CustomLoader)translator.FastGetCSObj(L, 1);
