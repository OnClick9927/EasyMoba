...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkCoroutineCoroutineModuleExWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Coroutine.CoroutineModuleEx);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.Coroutine.CoroutineModuleEx does not have a constructor!");
        }
