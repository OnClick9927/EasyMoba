...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaNormalUIAssetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.NormalUIAsset);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<IFramework.UI.PanelPathCollect>(L, 2) && translator.Assignable<UnityEngine.Canvas>(L, 3))
				{
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.NormalUIAsset constructor!");
        ...
        static int _m_LoadItemAsync(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.NormalUIAsset gen_to_be_invoked = (EasyMoba.NormalUIAsset)translator.FastGetCSObj(L, 1);
        ...
        static int _m_ReleaseItemAsset(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.GameObject _releaseAsset = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
                    
                    gen_to_be_invoked.ReleaseItemAsset( _releaseAsset );
