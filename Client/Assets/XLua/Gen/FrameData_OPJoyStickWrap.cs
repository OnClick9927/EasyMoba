...
namespace XLua.CSObjectWrap
{
    ...
    public class FrameDataOPJoyStickWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FrameData.OPJoyStick);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FrameData.OPJoyStick gen_ret = new FrameData.OPJoyStick();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FrameData.OPJoyStick constructor!");
        ...
        static int _g_get_x(RealStatePtr L)
        {
		    try {
                ...
                FrameData.OPJoyStick gen_to_be_invoked = (FrameData.OPJoyStick)translator.FastGetCSObj(L, 1);
