...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixLuaLuaEXLuaTaskAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Lua.LuaEX.LuaTaskAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.Hotfix.Lua.ILuaTask>(L, 2))
				{
				...
				{
				    translator.Push(L, default(IFramework.Hotfix.Lua.LuaEX.LuaTaskAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaEX.LuaTaskAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Lua.LuaEX.LuaTaskAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
