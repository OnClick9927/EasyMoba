...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePoseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Pose);
			Utils.BeginObjectRegister(type, L, translator, 1, 4, 5, 2);
			Utils.RegisterFunc(L, Utils.OBJ_META_IDX, "__eq", __EqMeta);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToString", _m_ToString);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetTransformedBy", _m_GetTransformedBy);
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<UnityEngine.Pose>(L, 1) && translator.Assignable<UnityEngine.Pose>(L, 2))
				{
					UnityEngine.Pose leftside;translator.Get(L, 1, out leftside);
					UnityEngine.Pose rightside;translator.Get(L, 2, out rightside);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need UnityEngine.Pose!");
        ...
        static int _m_ToString(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Pose.ToString!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Pose>(L, 2)) 
                {
                    UnityEngine.Pose _other;translator.Get(L, 2, out _other);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Pose.Equals!");
        ...
        static int _g_get_identity(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.Pose.identity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
