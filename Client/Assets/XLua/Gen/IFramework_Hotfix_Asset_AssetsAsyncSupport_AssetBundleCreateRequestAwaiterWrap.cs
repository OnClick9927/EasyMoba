...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetsAsyncSupportAssetBundleCreateRequestAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.AssetsAsyncSupport.AssetBundleCreateRequestAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.AssetBundleCreateRequest>(L, 2))
				{
				...
				{
				    translator.Push(L, default(IFramework.Hotfix.Asset.AssetsAsyncSupport.AssetBundleCreateRequestAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.AssetsAsyncSupport.AssetBundleCreateRequestAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.AssetsAsyncSupport.AssetBundleCreateRequestAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
