...
namespace XLua.CSObjectWrap
{
    ...
    public class WooAssetNoneAssetStreamEncryptWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WooAsset.NoneAssetStreamEncrypt);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new WooAsset.NoneAssetStreamEncrypt();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WooAsset.NoneAssetStreamEncrypt constructor!");
        ...
        static int _m_DeCode(RealStatePtr L)
        {
		    try {
                ...
                WooAsset.NoneAssetStreamEncrypt gen_to_be_invoked = (WooAsset.NoneAssetStreamEncrypt)translator.FastGetCSObj(L, 1);
