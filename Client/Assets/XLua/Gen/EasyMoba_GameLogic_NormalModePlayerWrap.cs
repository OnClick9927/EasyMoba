...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicNormalModePlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.NormalModePlayer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MatchRoomType>(L, 2) && translator.Assignable<System.Collections.Generic.List<long>>(L, 3))
				{
					...
					var gen_ret = new EasyMoba.GameLogic.NormalModePlayer(_type, _roles);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.GameLogic.NormalModePlayer constructor!");
        ...
        static int _m_CallServerReady(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.NormalModePlayer gen_to_be_invoked = (EasyMoba.GameLogic.NormalModePlayer)translator.FastGetCSObj(L, 1);
