...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkCoroutineCoroutineAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Coroutine.CoroutineAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.Coroutine.ICoroutine>(L, 2))
				{
				...
				{
				    translator.Push(L, default(IFramework.Coroutine.CoroutineAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Coroutine.CoroutineAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Coroutine.CoroutineAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
