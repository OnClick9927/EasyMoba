...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 6, 8, 6, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToLVector2XZ", _m_ToLVector2XZ);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToLVector2XZ(RealStatePtr L)
        {
		    try {
