...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAssetBundleCreateRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.AssetBundleCreateRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.AssetBundleCreateRequest();
        ...
        static int _m_GetAwaiter(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AssetBundleCreateRequest gen_to_be_invoked = (UnityEngine.AssetBundleCreateRequest)translator.FastGetCSObj(L, 1);
