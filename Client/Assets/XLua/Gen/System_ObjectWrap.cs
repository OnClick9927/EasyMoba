    ...
    public class SystemObjectWrap 
    {
        ...
        static int _m_StartCoroutine(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<System.Collections.IEnumerator>(L, 2)&& translator.Assignable<IFramework.EnvironmentType>(L, 3)) 
                {
                    ...
                    IFramework.EnvironmentType _envType;translator.Get(L, 3, out _envType);
                    
                        var gen_ret = gen_to_be_invoked.StartCoroutine( _routine, _envType );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<System.Collections.IEnumerator>(L, 2)&& translator.Assignable<IFramework.IEnvironment>(L, 3)) 
                {
                    System.Collections.IEnumerator _routine = (System.Collections.IEnumerator)translator.GetObject(L, 2, typeof(System.Collections.IEnumerator));
                    IFramework.IEnvironment _env = (IFramework.IEnvironment)translator.GetObject(L, 3, typeof(IFramework.IEnvironment));
                    
                        var gen_ret = gen_to_be_invoked.StartCoroutine( _routine, _env );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to object.StartCoroutine!");
        ...
        static int _m_StopCoroutine(RealStatePtr L)
        {
		    try {
                ...
                {
                    IFramework.Coroutine.ICoroutine _routine = (IFramework.Coroutine.ICoroutine)translator.GetObject(L, 2, typeof(IFramework.Coroutine.ICoroutine));
