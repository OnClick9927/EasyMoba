...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineHash128Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.Hash128);
			Utils.BeginObjectRegister(type, L, translator, 2, 5, 1, 0);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "Compute", _m_Compute_xlua_st_);
        ...
        static int _m_CompareTo(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Hash128 gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
            
            
			    int gen_param_count = LuaAPI.lua_gettop(L);
            
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Hash128>(L, 2)) 
                {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Hash128.CompareTo!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Compute_xlua_st_(RealStatePtr L)
        {
		    try {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Hash128.Compute!");
        ...
        static int _m_Append(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    gen_to_be_invoked.Append( _data );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Hash128.Append!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Hash128.Equals!");
