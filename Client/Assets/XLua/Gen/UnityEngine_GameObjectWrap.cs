...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddLuaBehaviour", _m_AddLuaBehaviour);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddLuaBehaviour(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _requireParam = LuaAPI.lua_tostring(L, 2);
                        ...
                        IFramework.Hotfix.Lua.LuaBehaviour gen_ret = gen_to_be_invoked.AddLuaBehaviour( _requireParam );
                        translator.Push(L, gen_ret);
