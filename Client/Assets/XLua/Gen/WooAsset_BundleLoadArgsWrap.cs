...
namespace XLua.CSObjectWrap
{
    ...
    public class WooAssetBundleLoadArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WooAsset.BundleLoadArgs);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 4 && translator.Assignable<WooAsset.BundleLoadType>(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING))
				{
					WooAsset.BundleLoadType _type;translator.Get(L, 2, out _type);
					string _path = LuaAPI.lua_tostring(L, 3);
					string _bundleName = LuaAPI.lua_tostring(L, 4);
					
					var gen_ret = new WooAsset.BundleLoadArgs(_type, _path, _bundleName);
				...
				{
				    translator.Push(L, default(WooAsset.BundleLoadArgs));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WooAsset.BundleLoadArgs constructor!");
        ...
        static int _g_get_type(RealStatePtr L)
        {
		    try {
                ...
                WooAsset.BundleLoadArgs gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _s_set_type(RealStatePtr L)
        {
		    try {
                ...
                WooAsset.BundleLoadArgs gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                WooAsset.BundleLoadType gen_value;translator.Get(L, 2, out gen_value);
