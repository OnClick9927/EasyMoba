        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.Recorder.CommandState gen_ret = new IFramework.Recorder.CommandState();
		    ...
		    try {
                ...
                
                {
                    ...
                    IFramework.ICommand _undo = (IFramework.ICommand)translator.GetObject(L, 3, typeof(IFramework.ICommand));
                        ...
                        IFramework.Recorder.CommandState gen_ret = gen_to_be_invoked.SetCommand( _redo, _undo );
                        translator.Push(L, gen_ret);
