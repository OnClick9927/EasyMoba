...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.AudioBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AudioBehaviour gen_ret = new UnityEngine.AudioBehaviour();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioBehaviour gen_to_be_invoked = (UnityEngine.AudioBehaviour)translator.FastGetCSObj(L, 1);
