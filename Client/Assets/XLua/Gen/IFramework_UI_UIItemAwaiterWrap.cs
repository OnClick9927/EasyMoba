...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIUIItemAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.UIItemAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.UI.UIItem>(L, 2))
				{
				...
				{
				    translator.Push(L, default(IFramework.UI.UIItemAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.UIItemAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.UIItemAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
