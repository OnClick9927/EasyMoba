...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicBattleModePlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.BattleModePlayer);
        ...
        {
            return LuaAPI.luaL_error(L, "EasyMoba.GameLogic.BattleModePlayer does not have a constructor!");
        }
        ...
        static int _m_Dispose(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.BattleModePlayer gen_to_be_invoked = (EasyMoba.GameLogic.BattleModePlayer)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    EasyMoba.GameLogic.BattlePlayMode _mode;translator.Get(L, 1, out _mode);
                    ...
                    System.Collections.Generic.List<long> _roles = (System.Collections.Generic.List<long>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<long>));
                        ...
                        var gen_ret = EasyMoba.GameLogic.BattleModePlayer.Create( _mode, _type, _roles );
        ...
        static int _m_SendFrameToServer(RealStatePtr L)
        {
		    try {
                ...
                {
                    EasyMoba.GameLogic.BattleInput _recorder = (EasyMoba.GameLogic.BattleInput)translator.GetObject(L, 2, typeof(EasyMoba.GameLogic.BattleInput));
                    
                    gen_to_be_invoked.SendFrameToServer( _recorder );
