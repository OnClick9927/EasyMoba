...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "defaultMaxDepenetrationVelocity", _s_set_defaultMaxDepenetrationVelocity);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_defaultMaxDepenetrationVelocity(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushnumber(L, UnityEngine.Physics.defaultMaxDepenetrationVelocity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_defaultMaxDepenetrationVelocity(RealStatePtr L)
        {
		    try {
                
			    UnityEngine.Physics.defaultMaxDepenetrationVelocity = (float)LuaAPI.lua_tonumber(L, 1);
