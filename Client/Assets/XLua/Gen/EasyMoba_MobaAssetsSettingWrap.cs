...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaMobaAssetsSettingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.MobaAssetsSetting);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					EasyMoba.MobaAssetsSetting gen_ret = new EasyMoba.MobaAssetsSetting();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.MobaAssetsSetting constructor!");
        ...
        static int _m_GetUrlByBundleName(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.MobaAssetsSetting gen_to_be_invoked = (EasyMoba.MobaAssetsSetting)translator.FastGetCSObj(L, 1);
