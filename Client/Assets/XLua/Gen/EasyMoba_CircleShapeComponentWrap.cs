...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaCircleShapeComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.CircleShapeComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.CircleShapeComponent constructor!");
        ...
        static int _m_Build(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.CircleShapeComponent gen_to_be_invoked = (EasyMoba.CircleShapeComponent)translator.FastGetCSObj(L, 1);
