...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioDistortionFilterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.AudioDistortionFilter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AudioDistortionFilter gen_ret = new UnityEngine.AudioDistortionFilter();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioDistortionFilter gen_to_be_invoked = (UnityEngine.AudioDistortionFilter)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_distortionLevel(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioDistortionFilter gen_to_be_invoked = (UnityEngine.AudioDistortionFilter)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.distortionLevel);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_distortionLevel(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioDistortionFilter gen_to_be_invoked = (UnityEngine.AudioDistortionFilter)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.distortionLevel = (float)LuaAPI.lua_tonumber(L, 2);
