        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LockStep.Math.LVector3Int.Mathf();
		    ...
		    try {
                ...
                
                {
                    ...
                    int _b = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = LockStep.Math.LVector3Int.Mathf.Min( _a, _b );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _b = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = LockStep.Math.LVector3Int.Mathf.Max( _a, _b );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    LockStep.Math.LFloat _val;translator.Get(L, 1, out _val);
                        ...
                        var gen_ret = LockStep.Math.LVector3Int.Mathf.Sqrt( _val );
                        translator.Push(L, gen_ret);
