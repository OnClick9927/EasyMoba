...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUILoadItemAsyncOperationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.LoadItemAsyncOperation);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.LoadItemAsyncOperation constructor!");
        ...
        static int _g_get_path(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.LoadItemAsyncOperation gen_to_be_invoked = (IFramework.UI.LoadItemAsyncOperation)translator.FastGetCSObj(L, 1);
