    ...
    public class LockStepMathLFloatWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new LockStep.Math.LFloat(_val);
        ...
        static int _m_CreateByRaw_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    long _rawVal = LuaAPI.lua_toint64(L, 1);
                    
                        var gen_ret = LockStep.Math.LFloat.CreateByRaw( _rawVal );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ToInt(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.ToInt(  );
        ...
        static int _m_ToLong(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.ToLong(  );
        ...
        static int _m_ToFloat(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.ToFloat(  );
        ...
        static int _m_ToDouble(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.ToDouble(  );
                        LuaAPI.lua_pushnumber(L, gen_ret);
        ...
        static int _m_Ceil(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.Ceil(  );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
