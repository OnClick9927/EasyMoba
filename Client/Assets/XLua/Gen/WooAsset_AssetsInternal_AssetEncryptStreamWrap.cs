...
namespace XLua.CSObjectWrap
{
    ...
    public class WooAssetAssetsInternalAssetEncryptStreamWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WooAsset.AssetsInternal.AssetEncryptStream);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 8 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && translator.Assignable<System.IO.FileMode>(L, 4) && translator.Assignable<System.IO.FileAccess>(L, 5) && translator.Assignable<System.IO.FileShare>(L, 6) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 7) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 8))
				{
					...
					var gen_ret = new WooAsset.AssetsInternal.AssetEncryptStream(_bundleName, _path, _mode, _access, _share, _bufferSize, _useAsync);
				...
				if(LuaAPI.lua_gettop(L) == 4 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && translator.Assignable<System.IO.FileMode>(L, 4))
				{
					...
					var gen_ret = new WooAsset.AssetsInternal.AssetEncryptStream(_bundleName, _path, _mode);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WooAsset.AssetsInternal.AssetEncryptStream constructor!");
        ...
        static int _m_Read(RealStatePtr L)
        {
		    try {
                ...
                WooAsset.AssetsInternal.AssetEncryptStream gen_to_be_invoked = (WooAsset.AssetsInternal.AssetEncryptStream)translator.FastGetCSObj(L, 1);
		    ...
		    try {
                ...
                
                {
                    ...
                    byte[] _buffer = LuaAPI.lua_tobytes(L, 2);
                        ...
                        var gen_ret = WooAsset.AssetsInternal.AssetEncryptStream.DeCode( _bundleName, _buffer );
		    ...
		    try {
                ...
                
                {
                    ...
                    byte[] _buffer = LuaAPI.lua_tobytes(L, 2);
                        ...
                        var gen_ret = WooAsset.AssetsInternal.AssetEncryptStream.EnCode( _bundleName, _buffer );
                        LuaAPI.lua_pushstring(L, gen_ret);
