...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIMaskableGraphicWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "isMaskingGraphic", _g_get_isMaskingGraphic);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "isMaskingGraphic", _s_set_isMaskingGraphic);
        ...
        static int _m_SetClipSoftness(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetClipSoftness( _clipSoftness );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_isMaskingGraphic(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.UI.MaskableGraphic gen_to_be_invoked = (UnityEngine.UI.MaskableGraphic)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.isMaskingGraphic);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_isMaskingGraphic(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.UI.MaskableGraphic gen_to_be_invoked = (UnityEngine.UI.MaskableGraphic)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.isMaskingGraphic = LuaAPI.lua_toboolean(L, 2);
