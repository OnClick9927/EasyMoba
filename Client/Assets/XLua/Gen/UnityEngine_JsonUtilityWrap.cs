...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineJsonUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.JsonUtility);
        ...
        static int _m_FromJsonOverwrite_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _json = LuaAPI.lua_tostring(L, 1);
                    object _objectToOverwrite = translator.GetObject(L, 2, typeof(object));
                    
                    UnityEngine.JsonUtility.FromJsonOverwrite( _json, _objectToOverwrite );
