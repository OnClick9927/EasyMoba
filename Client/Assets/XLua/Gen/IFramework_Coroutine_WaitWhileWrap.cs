...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkCoroutineWaitWhileWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Coroutine.WaitWhile);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Coroutine.WaitWhile constructor!");
