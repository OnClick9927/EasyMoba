...
namespace XLua.CSObjectWrap
{
    ...
    public class WooAssetAssetsVersionVersionDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WooAsset.AssetsVersion.VersionData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new WooAsset.AssetsVersion.VersionData();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WooAsset.AssetsVersion.VersionData constructor!");
        ...
        static int _g_get_bundleName(RealStatePtr L)
        {
		    try {
                ...
                WooAsset.AssetsVersion.VersionData gen_to_be_invoked = (WooAsset.AssetsVersion.VersionData)translator.FastGetCSObj(L, 1);
