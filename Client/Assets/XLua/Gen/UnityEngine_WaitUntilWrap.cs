...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineWaitUntilWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.WaitUntil);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Func<bool>>(L, 2))
				{
					...
					UnityEngine.WaitUntil gen_ret = new UnityEngine.WaitUntil(_predicate);
        ...
        static int _g_get_keepWaiting(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.WaitUntil gen_to_be_invoked = (UnityEngine.WaitUntil)translator.FastGetCSObj(L, 1);
