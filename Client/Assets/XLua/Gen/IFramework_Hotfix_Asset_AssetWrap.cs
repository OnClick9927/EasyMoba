...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 4 && translator.Assignable<IFramework.Hotfix.Asset.Bundle>(L, 2) && translator.Assignable<System.Collections.Generic.List<IFramework.Hotfix.Asset.Asset>>(L, 3) && translator.Assignable<IFramework.Hotfix.Asset.AssetLoadArgs>(L, 4))
				{
					...
					IFramework.Hotfix.Asset.AssetLoadArgs _loadArgs;translator.Get(L, 4, out _loadArgs);
					
					var gen_ret = new IFramework.Hotfix.Asset.Asset(_bundle, _dps, _loadArgs);
