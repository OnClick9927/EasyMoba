...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCapsuleColliderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.CapsuleCollider);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.CapsuleCollider gen_ret = new UnityEngine.CapsuleCollider();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CapsuleCollider gen_to_be_invoked = (UnityEngine.CapsuleCollider)translator.FastGetCSObj(L, 1);
