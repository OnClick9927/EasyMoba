...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsUpdateBehaviour2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.PhysicsUpdateBehaviour2D);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.PhysicsUpdateBehaviour2D gen_ret = new UnityEngine.PhysicsUpdateBehaviour2D();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.PhysicsUpdateBehaviour2D gen_to_be_invoked = (UnityEngine.PhysicsUpdateBehaviour2D)translator.FastGetCSObj(L, 1);
