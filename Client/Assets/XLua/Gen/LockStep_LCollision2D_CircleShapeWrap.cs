...
namespace XLua.CSObjectWrap
{
    ...
    public class LockStepLCollision2DCircleShapeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LockStep.LCollision2D.CircleShape);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LockStep.LCollision2D.CircleShape constructor!");
        ...
        static int _m_Build(RealStatePtr L)
        {
		    try {
                ...
                LockStep.LCollision2D.CircleShape gen_to_be_invoked = (LockStep.LCollision2D.CircleShape)translator.FastGetCSObj(L, 1);
