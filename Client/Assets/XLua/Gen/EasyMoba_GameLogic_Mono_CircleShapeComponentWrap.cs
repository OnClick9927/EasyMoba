...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicMonoCircleShapeComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.Mono.CircleShapeComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new EasyMoba.GameLogic.Mono.CircleShapeComponent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.GameLogic.Mono.CircleShapeComponent constructor!");
        ...
        static int _m_Build(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.Mono.CircleShapeComponent gen_to_be_invoked = (EasyMoba.GameLogic.Mono.CircleShapeComponent)translator.FastGetCSObj(L, 1);
