...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIEmpty4RaycastWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.Empty4Raycast);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.UI.Empty4Raycast does not have a constructor!");
        }
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.Empty4Raycast gen_to_be_invoked = (IFramework.UI.Empty4Raycast)translator.FastGetCSObj(L, 1);
