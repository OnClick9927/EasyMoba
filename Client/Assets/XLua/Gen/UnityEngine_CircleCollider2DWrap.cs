...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCircleCollider2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.CircleCollider2D);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.CircleCollider2D gen_ret = new UnityEngine.CircleCollider2D();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CircleCollider2D gen_to_be_invoked = (UnityEngine.CircleCollider2D)translator.FastGetCSObj(L, 1);
