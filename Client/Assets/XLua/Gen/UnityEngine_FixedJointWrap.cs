...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineFixedJointWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.FixedJoint);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.FixedJoint gen_ret = new UnityEngine.FixedJoint();
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.FixedJoint gen_to_be_invoked = (UnityEngine.FixedJoint)translator.FastGetCSObj(L, 1);
