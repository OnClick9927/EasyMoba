...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRectTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetPosInRootTrans", _m_GetPosInRootTrans);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AnchorPosX", _m_AnchorPosX);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetSizeWidth", _m_SetSizeWidth);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetSizeHeight", _m_SetSizeHeight);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetWorldSize", _m_GetWorldSize);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetPosInRootTrans(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AnchorPosX(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetSizeWidth(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetSizeHeight(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetWorldSize(RealStatePtr L)
        {
		    try {
