...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkArrayPoolArgWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.ArrayPoolArg);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(IFramework.ArrayPoolArg));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.ArrayPoolArg constructor!");
        ...
        static int _g_get_length(RealStatePtr L)
        {
		    try {
                ...
                IFramework.ArrayPoolArg gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
