...
namespace XLua.CSObjectWrap
{
    ...
    public class EasyMobaGameLogicMonoPlayerBornPlaceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EasyMoba.GameLogic.Mono.PlayerBornPlace);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new EasyMoba.GameLogic.Mono.PlayerBornPlace();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EasyMoba.GameLogic.Mono.PlayerBornPlace constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                EasyMoba.GameLogic.Mono.PlayerBornPlace gen_to_be_invoked = (EasyMoba.GameLogic.Mono.PlayerBornPlace)translator.FastGetCSObj(L, 1);
