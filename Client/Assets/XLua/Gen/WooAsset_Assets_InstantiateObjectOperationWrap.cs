...
namespace XLua.CSObjectWrap
{
    ...
    public class WooAssetAssetsInstantiateObjectOperationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WooAsset.Assets.InstantiateObjectOperation);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && translator.Assignable<UnityEngine.Transform>(L, 3))
				{
					...
					var gen_ret = new WooAsset.Assets.InstantiateObjectOperation(_path, _parent);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WooAsset.Assets.InstantiateObjectOperation constructor!");
        ...
        static int _m_Destroy(RealStatePtr L)
        {
		    try {
                ...
                WooAsset.Assets.InstantiateObjectOperation gen_to_be_invoked = (WooAsset.Assets.InstantiateObjectOperation)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Destroy_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    WooAsset.Assets.InstantiateObjectOperation.Destroy( _gameObject );
