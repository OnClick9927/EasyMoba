...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkRecorderBaseStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Recorder.BaseState);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.Recorder.BaseState does not have a constructor!");
        }
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Recorder.BaseState gen_to_be_invoked = (IFramework.Recorder.BaseState)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Subscribe(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Recorder.BaseState.Subscribe!");
