...
namespace XLua.CSObjectWrap
{
    ...
    public class TutorialByStringWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Tutorial.ByString);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Tutorial.ByString gen_ret = new Tutorial.ByString();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Tutorial.ByString constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                Tutorial.ByString gen_to_be_invoked = (Tutorial.ByString)translator.FastGetCSObj(L, 1);
