...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkPacketsPacketReaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Packets.PacketReader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Packets.PacketReader constructor!");
        ...
        static int _m_Set(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Packets.PacketReader gen_to_be_invoked = (IFramework.Packets.PacketReader)translator.FastGetCSObj(L, 1);
