...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate IFramework.IAwaiter __GEN_DELEGATE4( IFramework.Hotfix.Lua.ILuaTask target);
		
		delegate bool __GEN_DELEGATE5( string path);
		
		delegate bool __GEN_DELEGATE6( string path);
		
		delegate bool __GEN_DELEGATE7( string path);
		
		delegate string __GEN_DELEGATE8( string path,  string toCombinePath);
		
		delegate string __GEN_DELEGATE9( string path,  string[] paths);
		
		delegate string __GEN_DELEGATE10( string path);
		
		delegate void __GEN_DELEGATE11( string path);
		...
		delegate bool __GEN_DELEGATE14( System.Type self,  System.Type Interface);
		
		delegate bool __GEN_DELEGATE15( System.Type self,  System.Type genericType);
		
		delegate System.Collections.Generic.IList<System.Type> __GEN_DELEGATE16( System.Type t);
		
		delegate System.Collections.Generic.IEnumerable<System.Reflection.MethodInfo> __GEN_DELEGATE17( System.Type self,  System.Reflection.Assembly assembly);
		
		delegate string __GEN_DELEGATE18( string self);
		
		delegate string __GEN_DELEGATE19( string self,  string toPrefix);
		
		delegate string __GEN_DELEGATE20( string self,  string toAppend);
		
		delegate string __GEN_DELEGATE21( string self,  string[] toAppend);
		
		delegate void __GEN_DELEGATE22( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE23( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE24( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE25( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE26( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE27( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE28( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE29( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate string __GEN_DELEGATE30( string value,  System.Text.Encoding encoding);
		
		delegate string __GEN_DELEGATE31( string value,  System.Text.Encoding encoding);
		
		delegate IFramework.Recorder.CommandState __GEN_DELEGATE32( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.ActionState __GEN_DELEGATE33( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.CommandGroupState __GEN_DELEGATE34( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.ActionGroupState __GEN_DELEGATE35( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Coroutine.ICoroutine __GEN_DELEGATE36( object obj,  System.Collections.IEnumerator routine,  IFramework.EnvironmentType envType);
		
		delegate IFramework.Coroutine.ICoroutine __GEN_DELEGATE37( object obj,  System.Collections.IEnumerator routine,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE38( object obj,  IFramework.Coroutine.ICoroutine routine);
		
		delegate IFramework.Coroutine.ICoroutine __GEN_DELEGATE39( IFramework.Coroutine.ICoroutine self,  System.Action action);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(string), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE5(IFramework.Ex.ExistFile)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE6(IFramework.Ex.IsDirectory)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE7(IFramework.Ex.RemoveEmptyDirectory)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE8(IFramework.Ex.CombinePath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE9(IFramework.Ex.CombinePath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE10(IFramework.Ex.ToRegularPath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE11(IFramework.Ex.MakeDirectoryExist)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE18(IFramework.Ex.ToUnixLineEndings)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE19(IFramework.Ex.AppendHead)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE20(IFramework.Ex.Append)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE21(IFramework.Ex.Append)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE30(IFramework.Net.Crypt.ToSha1Base64)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE31(IFramework.Net.Crypt.ToMd5)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Hotfix.Lua.ILuaTask), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE4(IFramework.Hotfix.Lua.LuaEX.GetAwaiter)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(System.Type), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE14(IFramework.Ex.IsExtendInterface)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE15(IFramework.Ex.IsSubclassOfGeneric)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE16(IFramework.Ex.GetTypeTree)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE17(IFramework.Ex.GetExtensionMethods)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(System.Action), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE22(IFramework.Framework.BindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE23(IFramework.Framework.UnBindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE24(IFramework.Framework.BindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE25(IFramework.Framework.UnBindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE26(IFramework.Framework.BindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE27(IFramework.Framework.UnBindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE28(IFramework.Framework.BindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE29(IFramework.Framework.UnBindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Recorder.IOperationRecorderModule), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE32(IFramework.Recorder.OperationRecorderEx.AllocateCommand)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE33(IFramework.Recorder.OperationRecorderEx.AllocateAction)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE34(IFramework.Recorder.OperationRecorderEx.AllocateCommandGroup)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE35(IFramework.Recorder.OperationRecorderEx.AllocateActionGroup)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(object), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE36(IFramework.Coroutine.CoroutineModuleEx.StartCoroutine)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE37(IFramework.Coroutine.CoroutineModuleEx.StartCoroutine)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE38(IFramework.Coroutine.CoroutineModuleEx.StopCoroutine)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Coroutine.ICoroutine), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE39(IFramework.Coroutine.CoroutineModuleEx.OnCompelete)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
