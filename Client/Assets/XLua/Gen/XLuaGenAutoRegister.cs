...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit8(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(LockStep.LCollision2D.LogocWorld), LockStepLCollision2DLogocWorldWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(EasyMoba.UpdatePanel), EasyMobaUpdatePanelWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(IFramework.UI.UIItemAwaiter), IFrameworkUIUIItemAwaiterWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(IFramework.UI.UILayerData), IFrameworkUIUILayerDataWrap.__Register);
        ...
        static void wrapInit9(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(IFramework.UI.MVVM.UIViewModel), IFrameworkUIMVVMUIViewModelWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate LockStep.Math.LFloat __GEN_DELEGATE3( float a);
		
		delegate LockStep.Math.LFloat __GEN_DELEGATE4( int a);
		
		delegate LockStep.Math.LFloat __GEN_DELEGATE5( long a);
		
		delegate int __GEN_DELEGATE6( byte val, ref  int idx);
		
		delegate int __GEN_DELEGATE7( short val, ref  int idx);
		
		delegate int __GEN_DELEGATE8( int val, ref  int idx);
		
		delegate int __GEN_DELEGATE9( long val, ref  int idx);
		
		delegate int __GEN_DELEGATE10( sbyte val, ref  int idx);
		
		delegate int __GEN_DELEGATE11( ushort val, ref  int idx);
		
		delegate int __GEN_DELEGATE12( uint val, ref  int idx);
		
		delegate int __GEN_DELEGATE13( ulong val, ref  int idx);
		
		delegate int __GEN_DELEGATE14( bool val, ref  int idx);
		
		delegate int __GEN_DELEGATE15( string val, ref  int idx);
		
		delegate string __GEN_DELEGATE16( string self);
		
		delegate string __GEN_DELEGATE17( string self);
		
		delegate IFramework.IAwaiter __GEN_DELEGATE18( IFramework.Hotfix.Lua.ILuaTask target);
		
		delegate bool __GEN_DELEGATE19( string path);
		
		delegate bool __GEN_DELEGATE20( string path);
		
		delegate bool __GEN_DELEGATE21( string path);
		
		delegate string __GEN_DELEGATE22( string path,  string toCombinePath);
		
		delegate string __GEN_DELEGATE23( string path,  string[] paths);
		
		delegate string __GEN_DELEGATE24( string path);
		
		delegate void __GEN_DELEGATE25( string path);
		
		delegate System.Collections.Generic.IEnumerable<System.Type> __GEN_DELEGATE26( System.Type self);
		
		delegate System.Collections.Generic.IEnumerable<System.Type> __GEN_DELEGATE27( System.Type self);
		
		delegate bool __GEN_DELEGATE28( System.Type self,  System.Type Interface);
		
		delegate bool __GEN_DELEGATE29( System.Type self,  System.Type genericType);
		
		delegate System.Collections.Generic.IList<System.Type> __GEN_DELEGATE30( System.Type t);
		
		delegate System.Collections.Generic.IEnumerable<System.Reflection.MethodInfo> __GEN_DELEGATE31( System.Type self,  System.Reflection.Assembly assembly);
		
		delegate string __GEN_DELEGATE32( string self);
		
		delegate string __GEN_DELEGATE33( string self,  string toPrefix);
		
		delegate string __GEN_DELEGATE34( string self,  string toAppend);
		
		delegate string __GEN_DELEGATE35( string self,  string[] toAppend);
		
		delegate void __GEN_DELEGATE36( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE37( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE38( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE39( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE40( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE41( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE42( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE43( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate string __GEN_DELEGATE44( string value,  System.Text.Encoding encoding);
		
		delegate string __GEN_DELEGATE45( string value,  System.Text.Encoding encoding);
		
		delegate IFramework.Recorder.CommandState __GEN_DELEGATE46( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.ActionState __GEN_DELEGATE47( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.CommandGroupState __GEN_DELEGATE48( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.ActionGroupState __GEN_DELEGATE49( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Coroutine.ICoroutine __GEN_DELEGATE50( object obj,  System.Collections.IEnumerator routine,  IFramework.EnvironmentType envType);
		
		delegate IFramework.Coroutine.ICoroutine __GEN_DELEGATE51( object obj,  System.Collections.IEnumerator routine,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE52( object obj,  IFramework.Coroutine.ICoroutine routine);
		
		delegate IFramework.Coroutine.ICoroutine __GEN_DELEGATE53( IFramework.Coroutine.ICoroutine self,  System.Action action);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(int), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE4(LockStep.Math.LMath.ToLFloat)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(float), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE3(LockStep.Math.LMath.ToLFloat)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(long), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE5(LockStep.Math.LMath.ToLFloat)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(ulong), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE13(LockStep.Math.Util.HashCodeExtension.GetHash)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(bool), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE14(LockStep.Math.Util.HashCodeExtension.GetHash)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(string), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE15(LockStep.Math.Util.HashCodeExtension.GetHash)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE16(IFramework.UnityEx.ToAbsPath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE17(IFramework.UnityEx.ToAssetsPath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE19(IFramework.Ex.ExistFile)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE20(IFramework.Ex.IsDirectory)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE21(IFramework.Ex.RemoveEmptyDirectory)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE22(IFramework.Ex.CombinePath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE23(IFramework.Ex.CombinePath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE24(IFramework.Ex.ToRegularPath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE25(IFramework.Ex.MakeDirectoryExist)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE32(IFramework.Ex.ToUnixLineEndings)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE33(IFramework.Ex.AppendHead)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE34(IFramework.Ex.Append)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE35(IFramework.Ex.Append)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE44(IFramework.Net.Crypt.ToSha1Base64)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE45(IFramework.Net.Crypt.ToMd5)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Hotfix.Lua.ILuaTask), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE18(IFramework.Hotfix.Lua.LuaEX.GetAwaiter)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(System.Type), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE26(IFramework.Ex.GetSubTypesInAssembly)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE27(IFramework.Ex.GetSubTypesInAssemblys)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE28(IFramework.Ex.IsExtendInterface)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE29(IFramework.Ex.IsSubclassOfGeneric)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE30(IFramework.Ex.GetTypeTree)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE31(IFramework.Ex.GetExtensionMethods)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(System.Action), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE36(IFramework.Framework.BindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE37(IFramework.Framework.UnBindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE38(IFramework.Framework.BindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE39(IFramework.Framework.UnBindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Recorder.IOperationRecorderModule), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE46(IFramework.Recorder.OperationRecorderEx.AllocateCommand)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE47(IFramework.Recorder.OperationRecorderEx.AllocateAction)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE48(IFramework.Recorder.OperationRecorderEx.AllocateCommandGroup)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE49(IFramework.Recorder.OperationRecorderEx.AllocateActionGroup)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(object), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE50(IFramework.Coroutine.CoroutineModuleEx.StartCoroutine)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE51(IFramework.Coroutine.CoroutineModuleEx.StartCoroutine)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE52(IFramework.Coroutine.CoroutineModuleEx.StopCoroutine)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Coroutine.ICoroutine), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE53(IFramework.Coroutine.CoroutineModuleEx.OnCompelete)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
