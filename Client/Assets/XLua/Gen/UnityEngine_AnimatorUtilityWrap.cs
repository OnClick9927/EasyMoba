...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimatorUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.AnimatorUtility);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AnimatorUtility gen_ret = new UnityEngine.AnimatorUtility();
        ...
        static int _m_OptimizeTransformHierarchy_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    string[] _exposedTransforms = (string[])translator.GetObject(L, 2, typeof(string[]));
                    
                    UnityEngine.AnimatorUtility.OptimizeTransformHierarchy( _go, _exposedTransforms );
        ...
        static int _m_DeoptimizeTransformHierarchy_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.AnimatorUtility.DeoptimizeTransformHierarchy( _go );
